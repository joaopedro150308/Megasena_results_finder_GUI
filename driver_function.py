...
def iniciar_driver():
    ...
    arguments = ['--lang=pt-BR', '--window-size=(1920, 1080)', '--user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36 Edg/115.0.1901.203']
